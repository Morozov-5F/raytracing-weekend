...
rt_hittable_list_t *rt_scene_triangle_test(void)
{
    ...
    rt_hittable_t *side = rt_triangle_new(point3(-2, -2, 0), point3(2, -2, 0), point3(-2, 1, 0), rt_material_claim(mirror));
    ...
    rt_hittable_t *monkey_mesh = rt_instance_new(rt_triangle_mesh_new(vertices, sizeof(vertices)/sizeof(vertices[0]), triangles, triangle_count, green));
    rt_instance_rotate_y(monkey_mesh, 10);
    rt_instance_translate(monkey_mesh, vec3(0, -1, 3));
    rt_hittable_list_add(objects, monkey_mesh);

    rt_hittable_t *sphere = rt_sphere_new(point3(-4, 0, -4), 2, rt_material_claim(mirror));
