...
rt_box_t *rt_box_new(point3_t min, point3_t max, rt_material_t *material)
{
    ...
    rt_hittable_list_add(
        result->sides, (rt_hittable_t *)rt_aa_rect_new_yz(min.y, max.y, min.z, max.z, min.x, rt_material_claim(material)));
    // Right
    rt_hittable_list_add(
        result->sides, (rt_hittable_t *)rt_aa_rect_new_yz(min.y, max.y, min.z, max.z, max.x, rt_material_claim(material)));
    // Top
    rt_hittable_list_add(
        result->sides, (rt_hittable_t *)rt_aa_rect_new_xz(min.x, max.x, min.z, max.z, max.y, rt_material_claim(material)));
    // Bottom
    rt_hittable_list_add(
        result->sides, (rt_hittable_t *)rt_aa_rect_new_xz(min.x, max.x, min.z, max.z, min.y, rt_material_claim(material)));
    // Back
    rt_hittable_list_add(
        result->sides, (rt_hittable_t *)rt_aa_rect_new_xy(min.x, max.x, min.y, max.y, max.z, rt_material_claim(material)));
